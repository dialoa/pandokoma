...
\usepackage{hyperref}
\hypersetup{
  pdftitle={Sample document without KOMA class options},
  pdfauthor={Jane Doe},
      pdfborder={0 0 0},
  breaklinks=true}
...
%        ---------------------------------------------- extra title page
  ...
  %        ---------------------------------------------------- title line
      \title{Sample document without KOMA class options}
  %        ------------------------------------------------------ subtitle
  %        -------------------------------------------------------- author
      \author{Jane Doe}
  %        ------------------------------------------------ place and date
...
%------------------------------ if not place any raw titlepage code here
    \maketitle
      \begin{abstract}
  This example illustrates pandokoma out of the box (\texttt{scrartcl}
  class).
  \end{abstract}
