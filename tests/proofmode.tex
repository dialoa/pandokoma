...
%-----------------------------------------------------------------BUGFIX
%  note for v1: is this still needed? the command is commented out.
%---------------------------------------------------------------GEOMETRY
...
%----------------------------\  fps@figure: default placement of figures
%---------- Order has no impact: 'htbp' just means that LaTeX is allowed
